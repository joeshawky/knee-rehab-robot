...
class ADS1115Simulation(Node): 
    def __init__(self):
        super().__init__("ads1115_simulation") 
        self.init_parameters()
        self.init_variables()
        self.init_publishers()
        self.get_logger().info("ads1115 simulation node has been initialised.")


    def init_parameters(self):
        self.declare_parameter("ads1115_publisher_timer", 1.0)
    ...
    def init_variables(self):
        ...
        self.ads1115_publisher_timer = self.get_parameter("ads1115_publisher_timer").value
    ...
    def init_publishers(self):
        self.publisher = self.create_publisher(ForceTimeStamped, "ads1115_data", 10)
        self.timer = self.create_timer(self.ads1115_publisher_timer, self.publish_force)
...
def main(args=None):
    ...
    node = ADS1115Simulation() # MODIFY NAME
    rclpy.spin(node)
    rclpy.shutdown()
